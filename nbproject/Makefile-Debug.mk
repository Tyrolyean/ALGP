...
${OBJECTDIR}/Game/Area.o: Game/Area.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Game/Area.o Game/Area.cpp

${OBJECTDIR}/Game/Entitys/Entity.o: Game/Entitys/Entity.cpp
	${MKDIR} -p ${OBJECTDIR}/Game/Entitys
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Game/Entitys/Entity.o Game/Entitys/Entity.cpp

${OBJECTDIR}/Game/Entitys/Movable_entity.o: Game/Entitys/Movable_entity.cpp
	${MKDIR} -p ${OBJECTDIR}/Game/Entitys
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Game/Entitys/Movable_entity.o Game/Entitys/Movable_entity.cpp
